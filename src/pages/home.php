...
// Permite acesso a DAO via fachada
require_once __DIR__ . '/../fachada.php';

$produtoDao = $factory->getProdutoDao(); // mesmo estilo do salvaUsuario
    ...
    <div class="flex items-center space-x-6">
        <a href="carrinho.php" class="relative text-gray-700 hover:text-red-600">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.5 7h13L17 13M6 21a1 1 0 100-2 1 1 0 000 2M18 21a1 1 0 100-2 1 1 0 000 2" />
            </svg>
        ...
        <div class="relative inline-block text-left" id="dropdown-wrapper">
            <button id="dropdown-btn" type="button"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none rounded cursor-pointer">
